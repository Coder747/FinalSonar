...
public class AudioManager {
    ...
    public AudioManager(double topFreq, double bottomFreq, double chirpDuration, double chirpCycles, double sampleRate, float amplitude, boolean onlyRampUp) {
    ...
    public byte[] generateAudio() {
        ...
        for(int cycle=0; cycle < chirpCycles; cycle++){
            ...
            for (int sample = 0; sample < singleChirpSamples; sample++) {
                ...
                buffer[cycle*singleChirpSamples + sample]  = (float) (amplitude* Math.sin((float) phase));
